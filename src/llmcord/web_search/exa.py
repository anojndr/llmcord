...
from .search_constants import EXA_MCP_URL, HTTP_OK, MAX_ERROR_CHARS
    ...
    try:
        ...
        try:
            ...
            logger.debug(
                ...
                search_data.keys() if isinstance(search_data, dict) else type(search_data),
            )
